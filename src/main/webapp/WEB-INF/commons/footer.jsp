...
<script type="text/javascript" src="${ctx}/js/jquery-extend.js"></script>
<script type="text/javascript" src="${ctx}/js/lib-v1.js" charset="utf-8"></script>
<script type="text/javascript" src="${ctx}/js/taotao.js" charset="utf-8"></script>
