...
<link rel="stylesheet" type="text/css" href="${ctx}/css/psearch20131008.css" media="all" />
<link rel="stylesheet" type="text/css" href="${ctx}/css/psearch.onebox.css" media="all" />
<link rel="stylesheet" type="text/css" href="${ctx}/css/pop_compare.css" media="all" />
<script type="text/javascript" src="${ctx}/js/jquery-1.2.6.min.js"></script>
</head>
<body>
<script type="text/javascript" src="${ctx}/js/base-2011.js" charset="utf-8"></script>
<!-- header start -->
<jsp:include page="../commons/header.jsp" />
<!-- header end -->
<div class="w main">
	<div class="crumb">全部结果&nbsp;&gt;&nbsp;<strong>${keyWords}</strong></div>
<div class="clr"></div>
...
<!-- footer end -->
<script type="text/javascript" src="${ctx}/js/jquery.hashchange.js"></script>
<script type="text/javascript" src="${ctx}/js/search_main.js"></script>
